...
CC = gcc
C_SOURCES = $(wildcard kernel/*.c bin/*.c drivers/*.c libc/*.c cpu/*.c utils/*.c rfs/*.c mem/*.c proc/*.c lock/*.c)
HEADERS = $(wildcard kernel/*.h bin/*.h drivers/*.h libc/*h cpu/*.h utils/*.h rfs/*.h mem/*.h proc/*.h lock/*.h)
